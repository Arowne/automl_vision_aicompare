...
class AutoMLVisionClient():
    ...
    def add_project_image(self, project_id=None, file_path=None):
            ...
            response = requests.post(self.server_url + 'automl/vision/image/' + project_id + '/project', files=files, headers=self.headers)
            data = response.json()
    ...
    def add_project_tag(self, project_id=None, tag_name=None):
            ...
            response = requests.post(self.server_url + 'automl/vision/tag/' + project_id + '/project', data=payload, headers=self.headers)
            data = response.json()
    ...
    def add_image_tag(self, image_id=None, tag_id=None):
            ...
            response = requests.get(self.server_url + 'automl/vision/tag/' + tag_id + '/image/' + image_id, headers=self.headers)
            data = response.json()
    ...
    def train_project(self, project_id=None, training_name=None, training_time=None, provider=None):
            ...
            response = requests.post(self.server_url + 'automl/vision/train/' + project_id + '/project', data=payload, headers=self.headers)
            data = response.json()
            print(data)
